# y0=1.659, vx0=8.379, vy0=8.846, alpha=46.6
import math
import csv
...
class Frisbee:
    ...
    def simulate(y0, vx0, vy0, alpha, delta_t):
        ...
        def update(frame):
            ...
            ax.set_title('Frisbee Trajectory for attacking angle 46.6 degree')
...
Frisbee.simulate(y0=1.659, vx0=8.379, vy0=8.846, alpha=46.6, delta_t=0.1)
