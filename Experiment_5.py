# y0=1.275, vx0=10.72, vy0=1.621, alpha=8.6
import math
import csv
...
class Frisbee:
    ...
    def simulate(y0, vx0, vy0, alpha, delta_t):
        ...
        def update(frame):
            ...
            ax.set_title('Frisbee Trajectory for attacking angle 8.6 degree')
...
Frisbee.simulate(y0=1.275, vx0=10.72, vy0=1.621, alpha=8.6, delta_t=0.1)
