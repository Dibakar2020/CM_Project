# y0=1.407, vx0=14.20, vy0=6.87, alpha=25.8, delta_t=0.01;   experiment 2
...
class Frisbee:
    ...
    def simulate(y0, vx0, vy0, alpha, delta_t):
        ...
        def update(frame):
            ...
            ax.set_title('Frisbee Trajectory for attacking angle 25.8 degree')
...
Frisbee.simulate(y0=1.407, vx0=13.895, vy0=2.84, alpha=21.8, delta_t=0.1)
