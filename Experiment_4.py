# y0=1.227, vx0=9.143, vy0=2.528, alpha=15.5
import math
import csv
...
class Frisbee:
    ...
    def simulate(y0, vx0, vy0, alpha, delta_t):
        ...
        def update(frame):
            ...
            ax.set_title('Frisbee Trajectory for attacking angle 15.5 degree')
...
Frisbee.simulate(y0=1.227, vx0=9.143, vy0=2.528, alpha=15.5, delta_t=0.1)
